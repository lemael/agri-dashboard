...
router.post('/', async (req, res) => {
  try {
    ...
    await pool.query(
      'INSERT INTO orders (id, grossiste_email, commande_at, status, produit) VALUES ($1, $2, $3, $4, $5)',
      [newId, grossisteEmail, commandeAt || new Date().toISOString(), status || 'en attente', JSON.stringify(produit)]
    );
